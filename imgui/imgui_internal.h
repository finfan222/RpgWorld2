...
struct ImPool
{
    ...
    void        Clear()                             { for (int n = 0; n < Map.Data.Size; n++) { int idx = Map.Data[n].val_i; if (idx != -1) Buf[idx].~T(); } Map.Clear(); Buf.cleanUp(); FreeIdx = AliveCount = 0; }
...
struct ImGuiTextIndex
{
    ...
    void            cleanUp()                                 { LineOffsets.cleanUp(); EndOffset = 0; }
...
struct ImDrawDataBuilder
{
    ...
    void ClearFreeMemory()          { for (int n = 0; n < IM_ARRAYSIZE(Layers); n++) Layers[n].cleanUp(); }
...
struct IMGUI_API ImGuiInputTextState
{
    ...
    void        ClearFreeMemory()           { TextW.cleanUp(); TextA.cleanUp(); InitialTextA.cleanUp(); }
...
struct ImGuiKeyRoutingTable
{
    ...
    void Clear()                    { for (int n = 0; n < IM_ARRAYSIZE(Index); n++) Index[n] = -1; Entries.cleanUp(); EntriesNext.cleanUp(); }
};
